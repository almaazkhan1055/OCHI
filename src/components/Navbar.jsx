...
//           className="text-[22vw] leading-none text-[Founders_Grotesk_X-Condensed] font-semibold uppercase mb-10 pt-5 tracking-tighter pr-20 md:text-[30vw]"
//         >
//           We are ochi
//         </motion.h1>
//         <motion.h1
...
function Navbar() {
  ...
  return (
    <div className="fixed z-[999] w-full px-6 py-4 md:px-20 md:py-8 font-['Neue Montreal'] flex justify-between items-center bg-black">
      {" "}
      ...
      <div
        className={`${
          isOpen ? "block" : "hidden"
        } absolute top-16 left-0 w-full bg-black md:static md:flex md:gap-10 md:items-center md:w-auto`}
      >
        {" "}
