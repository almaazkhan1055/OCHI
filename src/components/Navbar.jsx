...
function Navbar() {
  ...
  return (
    <div className="fixed z-[999] w-full px-6 py-4 md:px-20 md:py-8 font-['Neue Montreal'] flex justify-between items-center bg-zinc-900">
      <div className="logo">
        <svg
          width="72"
          height="30"
      ...
      <div className="md:hidden">
        ...
        >
          {!isOpen ? (
            <RiMenu2Fill className="text-[30px]" />
          ) : (
