...
function About() {
  return (
    <div className="w-full bg-[#cdea68] rounded-tr-3xl rounded-tl-3xl text-black">
      ...
      <div className="w-full border-t-[1px] border-zinc-800 mt-16 md:mt-32 flex flex-col md:flex-row justify-between items-center py-5 px-6 md:px-20 text-xl md:text-2xl gap-6 md:gap-52">
        {" "}
      ...
      <div className="w-full flex flex-col md:flex-row gap-6 md:gap-10 border-t-[1px] border-[#a1b562] mt-10 md:mt-20 pt-10 md:pt-10 p-6 md:p-20">
        ...
        <div className="w-full md:w-1/2">
          {" "}
          <h1 className="text-5xl md:text-7xl mb-6 md:mb-10">
            Our approach:
          </h1>{" "}
