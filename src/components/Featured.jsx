      ...
      <div className="p-6 md:p-10">
        ...
        <div className="cards w-full flex flex-col md:flex-row gap-10">
          ...
          <div className="w-full md:w-1/2">
            {" "}
            <p className="text-lg md:text-xl mb-6 md:mb-10">FYDE</p>{" "}
            <motion.div
          ...
          <div className="w-full md:w-1/2">
            {" "}
            <p className="text-lg md:text-xl mb-6 md:mb-10">VISE</p>{" "}
            <motion.div
            ...
            >
              {" "}
              <motion.h1 className="absolute right-full text-[#cdea68] z-[9] translate-x-1/2 -translate-y-1/2 top-1/2 font-semibold text-7xl md:text-9xl leading-none tracking-tighter text-['Founders_Grotesk_X-Condensed'] flex">
                {" "}
